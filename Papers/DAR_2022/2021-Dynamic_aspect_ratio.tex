...
process takes about 10-15 minutes on a mid-end Intel i7 computer, including a
low resolution transcode to allow ffmpeg to detect scene shifts for more
plesant transitions on camera angle changes. Transcoding is done as I-frames
are periodic, as the video files have been optimized for streaming. If no
...
more pleasing crop, ensuring that people are framed and not cut down the
middle. The AI crop is also dynamic, and will pan automatically to hold a
person in the frame, which is particularly imporant for 9:16 crops where a
person fills most of the width. If people are looking sideways, it is more
natural to have more space in front of their face than around the back. Our
solution centers on the nose, ensuring a fairly natural crop, as shown in
