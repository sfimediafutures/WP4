    ...
    var ResponsiveVoice = function() {
        ...
        a.speak = function(b, c, d) {
            if (a.rvsMapped) {
                ...
                if (a.iOS9 && !a.iOS9_initialized)
                    ...
                    a.setDefaultVoice(g.name)) : g = a.getResponsiveVoice(c);
                    ...
                    for (g = 0; g < k.length; g++)
                        if (!a.fallbackMode && a.getServiceEnabled(a.services.NATIVE_TTS))
                            ...
                            null != d ? (e.voice = "undefined" !== typeof d.voice ? d.voice : f.systemvoice,
                            g < k.length - 1 && 1 < k.length ? (e.onend = a.onPartEnd,
                            e.hasOwnProperty("addEventListener") && e.addEventListener("end", a.onPartEnd)) : (e.onend = a.speech_onend,
                            e.hasOwnProperty("addEventListener") && e.addEventListener("end", a.speech_onend)),
                            e.onerror = d.onerror || function(b) {
                            ...
                            e.volume = null != d.volume ? d.volume : e.volume) : (a.log("No Params received for current Utterance"),
                            ...
                            null != d && (e *= null != d.pitch ? d.pitch : 1,
                            l *= null != d.rate ? d.rate : 1,
                            m *= null != d.volume ? d.volume : 1,
                            n = d.extraParams || null);
                            e /= 2;
                            l /= 2;
                            m *= 2;
                    ...
                    a.fallbackMode && a.getServiceEnabled(a.services.FALLBACK_AUDIO) && (a.fallback_part_index = 0,
        ...
        a.fallback_startPart = function() {
            ...
            if (null == a.fallback_audio)
              ...
              var b;
              if (a.fallback_audiopool.length > 0) {
                b = a.fallback_audiopool[0];
              } else {
                b = a.fallback_audio;
