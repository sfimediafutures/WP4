...
\keywords{Dynamic aspect ratio, Late binding, Focus track, Multi-device,
 client side}
...
positioning was compared to a manual selection. A "hit" was defined as the AI
focus point being within the screen of a the AI based crop, and a "miss" as
focus points outside of the crop. This means that the narrower the screen the
higher the possibility of missing. A comparison with a "fixed" crop around
the center of the screen was also performed in order to visualize the benefit
of a dynamic crop. The drama series using our hybrid face and generic AI
performed very well, as illustrated in figure \ref
...
%% TODO: The finished content were then tested by a test panel provided by
